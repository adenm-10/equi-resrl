...
| `test_run_package.py` | 1 | no | Run packages persist locally, wandb keeps exactly one best upload (checked against a fake wandb), and a saved residual model reloads to identical actions. |
